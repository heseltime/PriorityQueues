...
class HeapTest {
  ...
  public Heap<Integer> hq; // heap based queue of integers
  public Heap<String> hq2; // try some different data types for template test
  ...
  void setUp() {
    ...
    hq2 = new Heap<>();
    System.out.println("heap queue 2 set up");
  }
  ...
  void tearDown() {
    ...
    hq2 = null;
    System.out.println("heap queue 2 released");
  }
